  ...
  return (
    <div className="flex w-full flex-col gap-7">
      <div className="flex flex-col gap-2">
        <h1 className="font-display text-display font-bold tracking-display">{title}</h1>
        {description && <p className="text-muted-foreground text-body-lg leading-relaxed">{description}</p>}
      </div>
      {children}
    </div>
  );
