      ...
      {data.map((d, i) => {
        ...
        return (
          <div key={d.date} className="relative flex flex-1 flex-col items-center gap-1">
            {d.views > 0 && (
              <span className="text-text-3 absolute -top-5 w-full text-center font-mono text-mini">{d.views}</span>
            )}
            <div
            ...
            />
            {showLabel && (
              <span className="text-text-3 absolute -bottom-5 font-mono text-mini whitespace-nowrap">
